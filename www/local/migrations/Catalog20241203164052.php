...
class Catalog20241203164052 extends Version
{
  protected $author = "admin";

  protected $description = "Инфоблок теперь торговый каталог. Добавлено свойство \"ID карточки из таблицы \"Номенклатура\"\"";
  ...
  public function up()
  {
    ...
    $helper->Iblock()->saveProperty($iblockId, array(
      'NAME' => 'ID карточки из таблицы "Номенклатура"',
      'ACTIVE' => 'Y',
      'SORT' => '500',
      'CODE' => 'CARD_ID',
      'DEFAULT_VALUE' => '',
