                ...
                <div class="marketplace">
                    <a x-show="currentOffer.PROPERTIES.ARTICUL_OZON.VALUE"
                        ...
                        <svg class="marketplace-link__logo" viewBox="0 0 78 77" fill="none"
                            ...
                            <mask id="mask0_260_2632" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0"
                                width="78" height="77">
                                <path
                            ...
                            <g mask="url(#mask0_260_2632)">
                                ...
                                <mask id="mask1_260_2632" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                    width="78" height="77">
                    ...
                    <a x-show="currentOffer.PROPERTIES.ARTICUL_WB.VALUE"
                        :href="`https://www.wildberries.ru/catalog/${currentOffer.PROPERTIES.ARTICUL_WB.VALUE}/detail.aspx`"
                        target="_blank" class="marketplace-link">
