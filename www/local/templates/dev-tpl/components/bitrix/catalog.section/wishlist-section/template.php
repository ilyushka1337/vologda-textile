    ...
    <div class="products-grid">
        <?php foreach ($arResult['ITEMS'] as $item): ?>
            <div class="wishlist-item">
                ...
                ?>
                <button hx-vals='{"id": "<?= $item['ID'] ?>"}'
                    hx-post="/bitrix/services/main/ajax.php?action=placestart:wishlist.htmlApi.WishlistApi.remove"
                    hx-target="body" hx-swap="beforeend" class="remove">
