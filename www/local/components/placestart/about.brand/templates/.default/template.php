    ...
    <div class="container">
        <div class="text-grid">
            ...
            <div class="text-column">
                ...
                <div class="column">
                    <div class="content-text">
                        <p>Этот шаг стратегически важен для компании, поскольку позволяет активно участвовать в развитии
                            рынка
                            домашнего текстиля, поставляя высококачественные изделия напрямую конечным потребителям.</p>
                    </div>
                </div>
                <div class="column">
                    <div class="content-text">
                ...
                <div class="column">
                    <div class="content-text">
                        <p>Продукция комбината представлена на основных электронных площадках, это обеспечивает нам
                            быструю
                            обратную связь с конечным пользователем, поддерживая продажи в эпоху цифровой
                            трансформации. 
                        </p>
                    </div>
                    <?= tpl('ui/page-link', [
