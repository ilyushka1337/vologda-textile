...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ContentV2CardsUpdatePostBodyItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Placestart\WildberriesApi\Model\ContentV2CardsUpdatePostBodyItem::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Placestart\WildberriesApi\Model\ContentV2CardsUpdatePostBodyItem::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Placestart\WildberriesApi\Model\ContentV2CardsUpdatePostBodyItem();
            ...
            if (\array_key_exists('dimensions', $data)) {
                $object->setDimensions($this->denormalizer->denormalize($data['dimensions'], \Placestart\WildberriesApi\Model\ContentV2CardsUpdatePostBodyItemDimensions::class, 'json', $context));
                unset($data['dimensions']);
            }
            if (\array_key_exists('characteristics', $data)) {
                $values = [];
                foreach ($data['characteristics'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \Placestart\WildberriesApi\Model\ContentV2CardsUpdatePostBodyItemCharacteristicsItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('sizes', $data)) {
                ...
                foreach ($data['sizes'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \Placestart\WildberriesApi\Model\ContentV2CardsUpdatePostBodyItemSizesItem::class, 'json', $context);
                }
        ...
        {
            return [\Placestart\WildberriesApi\Model\ContentV2CardsUpdatePostBodyItem::class => false];
        }
    }
} else {
    class ContentV2CardsUpdatePostBodyItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
