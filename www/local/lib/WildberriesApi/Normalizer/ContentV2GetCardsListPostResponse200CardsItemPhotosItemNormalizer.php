...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ContentV2GetCardsListPostResponse200CardsItemPhotosItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Placestart\WildberriesApi\Model\ContentV2GetCardsListPostResponse200CardsItemPhotosItem::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Placestart\WildberriesApi\Model\ContentV2GetCardsListPostResponse200CardsItemPhotosItem::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Placestart\WildberriesApi\Model\ContentV2GetCardsListPostResponse200CardsItemPhotosItem();
        ...
        {
            return [\Placestart\WildberriesApi\Model\ContentV2GetCardsListPostResponse200CardsItemPhotosItem::class => false];
        }
    }
} else {
    class ContentV2GetCardsListPostResponse200CardsItemPhotosItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
